...
const valores = [
  {
    name: 'Aproximação com o público',
...
function Sobre() {
  return (
    <div>
      ...
      <section className=" bg-white px-6 py-16 sm:py-16 lg:px-8">
                    ...
                    <li >
                      <div>
                        ...
                        <div className="mt-4 flex items-center justify-center space-x-3 text-base">
                          <div className="font-semibold text-gray-900">{valor.name}</div>
                        </div>
                      </div>
                    </li>
                  ))}
      ...
      <div className="bg-blue-100 py-16 sm:py-16">
        <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
          <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-2 mx-auto max-w-7xl px-6 lg:px-8 pb-12">
            <div className="flex flex-col-reverse">
              <p className="text-lg leading-7 text-black-300">A implementação de projetos sustentáveis requer financiamento adequado.
              ...
              <h3 className="text-2xl font-bold leading-9 tracking-tight text-black pb-8">Qual o problema social que queremos resolver?</h3>
            </div>
            <div className="flex flex-col-reverse">
              <p className="text-lg leading-7 text-black-300">
              ...
              <h3 className="text-2xl font-bold leading-9 tracking-tight text-black pb-8">
      ...
      <div className="bg-white-400 py-24 sm:py-32">
            ...
            {equipe.map((equipe) => (
              <li key={equipe.name}>
                <div className="flex items-center gap-x-6">
                  <img className="h-16 w-16 rounded-full" src={equipe.imageUrl} alt="" />
                  <div>
                    <h3 className="text-base font-semibold leading-7 tracking-tight text-gray-900">{equipe.name}</h3>
                    <p className="text-sm font-semibold leading-6 text-gray-600">{equipe.role}</p>
                    <li key={equipe.name}>
                      <div className="flex items-center gap-x-1">
                        <a href={equipe.linkedin}>
                          <img className="h-5 w-5" src={imgLinkedin} alt="" />
                        </a>
                        <a href={equipe.gitHub}>
                          <img className="h-5 w-5" src={imgGitHub} alt="" />
                        </a>
                      </div>
                    </li>
                  </div>
