            ...
            <div className=' flex flex-col justify-between '>
                ...
                >
                    ...
                    <div className="flex w-ful items-center gap-4">
                        <img src={projeto.usuario?.foto === " " || null ? "https://tempodepolitica.com.br/wp-content/uploads/2020/05/sh_ong_111901871.jpg" : projeto.usuario?.foto} className='w-8 h-8 rounded-full' alt="" />
                        <p className='text-base font-semibold text-slate-500'>{projeto.usuario?.nome}</p>
                    </div>
                    ...
                    <div className="flex justify-between">
                        ...
                        <Button className="px-4 bg-red-500"  >
                            <Link to={`/deletarProjeto/${projeto.id}`}> <Trash size={20} /></Link>
                        </Button>
                    </div>
            ...
            <div className=' flex flex-col justify-between '>
                ...
                >
                    ...
                    <div className="flex w-full items-center gap-4">
                        <img src={projeto.usuario?.foto === " " || null ? "https://tempodepolitica.com.br/wp-content/uploads/2020/05/sh_ong_111901871.jpg" : projeto.usuario?.foto} className='h-8 w-8 rounded-full' alt="" />
                        <p className='text-base font-semibold text-slate-500'>{projeto.usuario?.nome}</p>
                    </div>
                    ...
                    <Button className='px-6 bg-blue-500 '>
                        ...
                        <svg className="-mr-1 mt-1 ml-2 h-4 w-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path
                                fillRule="evenodd"
